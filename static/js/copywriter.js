...
'<span style="font-size:12px;color:var(--text2);">模型</span><select id="cwModel" style="padding:4px 6px;border:1px solid rgba(255,255,255,.25);border-radius:6px;font-size:12px;background:rgba(255,255,255,.1);color:var(--text);"><option value="qwen3-vl-flash" selected>Qwen3-VL Flash</option><option value="qwen3-vl-plus">Qwen3-VL Plus</option><option value="qwen3.6-plus">Qwen3.6 Plus</option><option value="gpt-image-2">GPT-Image2</option><option value="qwen-image">Qwen-Image</option><option value="qwen-image-plus">Qwen-Image Plus</option></select></div></div>'+
...
'<div class="card" id="spiCard"><div class="card-title"><span class="icon">🎨</span><span class="spi-title-text">AI生成卖点手绘稿</span><span style="flex:1;"></span><button class="btn btn-outline btn-sm" id="spiExpand" style="font-size:11px;">🔍 展开</button><button class="btn btn-outline btn-sm" id="spiFeedbackTab" style="font-size:11px;margin-left:4px;">💬 反馈</button><button class="btn btn-outline btn-sm" id="spiDebugBtn" style="font-size:11px;margin-left:4px;" title="调试面板">🐛</button></div><div id="spiDebug" style="display:none;margin-bottom:12px;padding:14px;background:rgba(0,0,0,.5);border:1px solid rgba(255,255,255,.1);border-radius:10px;font-size:13px;font-family:monospace;color:#fff;max-height:400px;overflow-y:auto;white-space:pre-wrap;line-height:1.7;"></div><div id="spiLayout" style="display:flex;gap:24px;align-items:flex-start;"><div id="spiUploadSlot" style="flex:0 0 190px;height:280px;border:1.5px dashed rgba(255,255,255,.12);border-radius:10px;display:flex;align-items:center;justify-content:center;cursor:pointer;background:rgba(255,255,255,.03);overflow:hidden;position:relative;" title="上传裤子照片"><span id="spiUploadHint" style="font-size:13px;color:var(--text2);text-align:center;line-height:1.5;">📷<br>点击或拖拽<br>上传裤子照片</span><img id="spiUploadPreview" style="display:none;width:100%;height:100%;object-fit:cover;position:absolute;top:0;left:0;"><input type="file" id="spiFileInput" accept="image/*" style="display:none;"></div><div id="spiControls" style="display:flex;flex-direction:column;gap:10px;min-width:140px;"><button class="btn btn-primary" id="spiGen" style="padding:14px 16px;font-size:13px;">🎨 AI 一键生成</button><button class="btn btn-primary" id="spiExport" style="padding:12px 16px;font-size:13px;">💾 导出 PNG</button><button class="btn btn-primary" id="spiReset" style="padding:12px 16px;font-size:13px;">↺ 重置</button><div style="margin-top:4px;"><span style="font-size:11px;color:var(--text2);">模型</span><select id="spiModel" style="width:100%;padding:4px 6px;margin-top:2px;border:1px solid rgba(255,255,255,.25);border-radius:6px;font-size:11px;background:rgba(255,255,255,.1);color:var(--text);"><option value="qwen3.7-plus" selected>Qwen3.7 Plus</option><option value="qwen3.7-max">Qwen3.7 Max</option><option value="qwen3.6-max-preview">Qwen3.6 Max</option><option value="glm-5.1">GLM-5.1</option><option value="gpt-image-2">GPT-Image2</option><option value="qwen-image">Qwen-Image</option><option value="qwen-image-plus">Qwen-Image Plus</option></select></div><div style="margin-top:4px;"><span style="font-size:11px;color:var(--text2);">生图模型</span><select id="spiImageModel" style="width:100%;padding:4px 6px;margin-top:2px;border:1px solid rgba(255,255,255,.25);border-radius:6px;font-size:11px;background:rgba(255,255,255,.1);color:var(--text);"><option value="gpt-image-2">GPT-Image2</option><option value="qwen-image" selected>Qwen-Image</option><option value="qwen-image-plus">Qwen-Image Plus</option></select></div><button class="btn btn-outline" id="spiGenImage" style="padding:10px 16px;font-size:12px;margin-top:2px;">🎨 生成手绘稿</button><div id="spiStatus" style="margin-top:6px;font-size:11px;color:var(--text2);line-height:1.5;"></div><div class="spi-hint">拖拽=调整位置<br>双击=编辑<br>右键=清除</div></div><div id="spiCanvasWrap" style="flex:0 0 340px;min-width:0;"><canvas id="spiCanvas" width="1080" height="1600"></canvas></div></div></div>'+
