...
'<div class="cw-waist-row" style="display:flex;align-items:center;gap:8px;justify-content:flex-end;margin-top:12px;">'+
'<span style="color:var(--text2);font-size:12px;">📐 腰型：</span><span id="cwWB" class="cw-waist-badge unknown">未知</span><span id="cwWD" style="font-size:12px;color:var(--text2);"></span>'+
'<select id="cwWSize" style="margin-left:4px;padding:4px 8px;border:1px solid rgba(255,255,255,.25);border-radius:6px;font-size:13px;background:rgba(255,255,255,.1);color:var(--text);display:none;" onchange="CW._onWSize()"><option value="">选择尺码</option></select>'+
'<select id="cWOverride" style="margin-left:4px;padding:5px 10px;border:1px solid rgba(255,255,255,.25);border-radius:6px;font-size:13px;background:rgba(255,255,255,.1);color:var(--text);display:none;" onchange="CW._onWO()"><option value="">腰型手动选</option><option value="中低腰">中低腰</option><option value="中高腰">中高腰</option><option value="高腰">高腰</option><option value="低腰">低腰</option></select>'+
...
'<div id="cwWCfgPanel" class="hidden" style="margin-top:8px;padding:10px 14px;background:rgba(255,255,255,.1);border-radius:8px;border:1px solid rgba(255,255,255,.2);text-align:right;"></div>'+
